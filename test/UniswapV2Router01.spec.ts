...
enum RouterVersion {
  ...
  HawkswapRouter = 'HawkswapRouter'
}

describe('HawkswapV2Router{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        ...
        [RouterVersion.HawkswapRouter]: fixture.router02
          ...
          expect(receipt.gasUsed).to.eq(
            {
              ...
              [RouterVersion.HawkswapRouter]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
          ...
          expect(receipt.gasUsed).to.eq(
            {
              ...
              [RouterVersion.HawkswapRouter]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
